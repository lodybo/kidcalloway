// Generated on 2016-01-27 using generator-angular-fullstack 2.0.13
'use strict';
      ...
      dist: {
        files: {
          src: [
            ...
            '!<%= yeoman.dist %>/public/assets/images/no-rev/*.{png,jpg,jpeg,gif,webp,svg}',
